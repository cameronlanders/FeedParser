...
After adding the FeedParser.cs and Article.cs classes to your application where you want to use them, you can simply reference FeedParser's public methods as you would with any other class.
